...
This directory contains a collection of tools for running Continuous Integration (CI) tests, conda/pip installation, and other development tools.
...
Please use pytest for the testing process.
